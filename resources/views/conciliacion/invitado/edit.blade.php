        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
              ...
              <div class="flex flex-col sm:flex-row justify-between px-5 pt-5">
                <div class="py-2">
                    ...
                    <li class="text-sm leading-normal pl-2 before:float-left before:pr-2 before:content-['/'] before:opacity-50">
                        <a class="opacity-50 hover:opacity-100" href="{{ route('conciliacion.invitado.index') }}">Invitados</a>
                    </li>
                ...
                <a href="{{ route('conciliacion.invitado.index') }}" class="text-white justify-center px-5 py-2 border-solid flex bg-blue-700 hover:bg-blue-800 rounded-3xl">
                    Atras
                </a>
            </div>
            ...
            <div class="mx-5 flex justify-center">
                ...
                <div class="overflow-hidden rounded-lg border bg-white border-gray-300 shadow-md m-5 p-5">
                    <form method="POST" class="flex flex-col gap-1" action="{{ route('conciliacion.invitado.update', $invitado->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="flex flex-col gap-1 sm:gap-4 sm:flex-row">
                          ...
                          <div class="w-full flex flex-col gap-1">
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                              <textarea class="resize-none block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" name="referencia" id="referencia" cols="30" rows="4" placeholder="">{{ $invitado->referencia }}</textarea>
