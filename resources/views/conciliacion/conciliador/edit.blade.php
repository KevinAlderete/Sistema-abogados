    ...
    <div class="w-full">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
              ...
              <div class="flex flex-col sm:flex-row justify-between px-5 pt-5">
                <div class="py-2">
                    ...
                    <li class="text-sm leading-normal pl-2 before:float-left before:pr-2 before:content-['/'] before:opacity-50">
                        <a class="opacity-50 hover:opacity-100" href="{{ route('conciliacion.conciliador.index') }}">Invitados</a>
                    </li>
                    <li class="text-sm pl-2 capitalize leading-normal before:float-left before:pr-2 before:content-['/']" aria-current="page">Editar invitado</li>
                    </ol>
                </div>
                <a href="{{ route('conciliacion.conciliador.index') }}" class="text-white justify-center px-5 py-2 border-solid flex bg-blue-500 hover:bg-blue-700 rounded-lg">
                    Atras
                </a>
            </div>
            ...
            <div class="mx-5 flex justify-center">
                ...
                <!-- component -->
                <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5 p-5">
                    <form method="POST" class="flex flex-col gap-1" action="{{ route('conciliacion.conciliador.update', $conciliador->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="sm:col-span-6 flex justify-center">
                          <button class="rounded-lg overflow-hidden border border-blue-500 shadow-lg mb-4 py-2 px-9 bg-blue-500 text-white hover:bg-blue-600">Actualizar</button> 
                        </div>
                      </form>
                </div>
