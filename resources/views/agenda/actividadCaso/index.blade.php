        ...
        <div class="bg-indigo-50 overflow-hidden shadow-sm sm:rounded-lg min-h-screen">
            ...
            <div class="flex flex-col sm:flex-row justify-between px-5 pt-5">
                <div class="py-2">
                    ...
                    <li class="text-sm pl-2 capitalize leading-normal before:float-left before:pr-2 before:content-['/']" aria-current="page">Diligencias</li>
                    </ol>
                </div>
                <a href="{{ route('agenda.actividadCaso.create') }}" class="text-white px-5 py-2 font-bold justify-center  border-solid flex bg-blue-700 hover:bg-blue-800 rounded-3xl">
                    <span class="pl-2">Añadir diligencia</span>
                </a>
            </div>
            ...
            <div class='mx-5 my-3 border bg-white border-gray-300 rounded'>
            ...
            <div class="overflow-hidden rounded-lg border border-gray-300 shadow-md m-5">
                ...
                <thead class="bg-gray-50">
                    ...
                    <th scope="col" class="px-6 py-4 font-medium text-gray-900 hidden sm:block">Hora</th>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-end gap-4">
                                        <a href="{{ route('agenda.actividadCaso.edit', $cas_actividad->id) }}" class="hover:text-blue-500 text-gray-600 hover:scale-110">
                                        ...
                                        <form class="hover:text-red-500 text-gray-600 hover:scale-110 boton-eliminar" method="POST" action="{{ route('agenda.actividadCaso.destroy', $cas_actividad->id) }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit">
                                                <svg
