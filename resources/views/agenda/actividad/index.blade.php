        ...
        <div class="bg-indigo-50 overflow-hidden shadow-sm sm:rounded-lg min-h-screen">
            ...
            <div class="flex justify-between px-5 pt-5">
                <div class="py-2">
                    ...
                    <li class="text-sm pl-2 capitalize leading-normal before:float-left before:pr-2 before:content-['/']" aria-current="page">Actividad</li>
                    </ol>
                </div>
                <a href="{{ route('agenda.actividad.create') }}" class="text-white px-1 py-2 overflow-hidden border border-blue-700 shadow-lg flex bg-blue-700 hover:bg-blue-800 rounded-3xl">
            ...
            <div class="overflow-hidden rounded-lg border border-gray-300 shadow-md m-5 scroll-table-e">
                ...
                <thead class="bg-gray-50">
                    ...
                    <th scope="col" class="px-6 py-4 font-medium text-gray-900 hidden sm:block">Lugar</th>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-end gap-4">
                                        <a href="{{ route('agenda.actividad.edit', $actividad->id) }}" class="hover:text-blue-500 text-gray-600 hover:scale-110">
                                        ...
                                        <form class="hover:text-red-500 text-gray-600 hover:scale-110 boton-eliminar" method="POST" action="{{ route('agenda.actividad.destroy', $actividad->id) }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit">
                                                <svg
