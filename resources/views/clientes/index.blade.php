    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-indigo-50 overflow-hidden shadow-sm sm:rounded-lg min-h-screen">
            ...
            <div class="flex justify-between px-5 pt-5">
                ...
                <a href="{{ route('clientes.create') }}" class="text-white px-5 py-2 overflow-hidden rounded-3xl border border-blue-700 shadow-lg flex font-bold bg-blue-700 hover:bg-blue-800">
                   <span class="pl-2">Añadir Cliente</span>
                </a>
            </div>
            ...
            <form method="GET">
                <div class="shadow flex border bg-white border-gray-300 rounded">
            ...
            <div class="overflow-hidden rounded-lg border border-gray-300 shadow-md m-5 scroll-table-e">
                <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                <thead class="bg-gray-50">
                    <tr>
                        <th scope="col" class="px-6 py-4 font-bold text-gray-900">Nombre</th>
                        <th scope="col" class="px-6 py-4 font-bold text-gray-900">Apellido</th>
                        <th scope="col" class="px-6 py-4 font-bold text-gray-900">Teléfono</th>
                        <th scope="col" class="px-6 py-4 font-bold text-gray-900">Dirección</th>
                        <th scope="col" class="px-6 py-4 font-bold text-gray-900">Estado del cliente</th>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-end gap-4">
                                        <a href="{{ route('clientes.show', $cliente->id) }}" class="hover:text-green-500 text-gray-600 hover:scale-110">
                                        ...
                                        <a href="{{ route('clientes.edit', $cliente->id) }}" class="hover:text-blue-500 text-gray-600 hover:scale-110">
                                            <svg xmlns="http://www.w3.org/2000/svg" 
                                            width="24" height="24" viewBox="0 0 24 24" 
                                            fill="none" stroke="currentColor" stroke-width="2" 
                                            stroke-linecap="round" stroke-linejoin="round" 
                                            class="feather feather-edit-2"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path>
                                            </svg>
                                        </a>
                                        ...
                                        <form class="hover:text-red-500 text-gray-600 hover:scale-110 boton-eliminar" method="POST" action="{{ route('clientes.destroy', $cliente->id) }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit">
                                                <svg
            ...
            <div class="overflow-hidden rounded-lg border border-gray-300 shadow-md m-5 py-3 px-5">
                {{ $clientes->links() }}
            </div>
        </div>
    </div>
