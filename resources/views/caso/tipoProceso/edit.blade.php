            ...
            <div class="bg-indigo-50 overflow-hidden shadow-sm sm:rounded-lg min-h-screen">
                <div class="flex justify-between px-5 pt-5">
                    <div class="py-2">
                        ...
                        <li class="text-sm pl-2 capitalize leading-normal before:float-left before:pr-2 before:content-['/']" aria-current="page">Editar proceso</li>
                        </ol>
                    </div>
                ...
                <div class="overflow-hidden rounded-lg border bg-white border-gray-200 shadow-md m-5 p-5">
                        ...
                        <form method="POST" class="flex flex-col gap-1" action="{{ route('caso.tipoProceso.update', $tipoProceso->id) }}">
                            @csrf
                            @method('PUT')
