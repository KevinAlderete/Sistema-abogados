        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-indigo-50 overflow-hidden shadow-sm sm:rounded-lg min-h-screen">
              <div class="flex flex-col sm:flex-row justify-between px-5 pt-5">
                <div class="py-2">
                    ...
                    <li class="text-sm pl-2 capitalize leading-normal before:float-left before:pr-2 before:content-['/']" aria-current="page">Editar parte contraria</li>
                    </ol>
                </div>
                <a href="{{ route('caso.parteContraria.index') }}" class="text-white justify-center font-bold px-5 py-2 border-solid flex bg-blue-700 hover:bg-blue-800 rounded-3xl">
                    Atras
                </a>
            </div>
            ...
            <div class="mx-5 flex justify-center">
                ...
                <div class="overflow-hidden rounded-lg border bg-white border-gray-300 shadow-md m-5 p-5">
                    <form method="POST" class="flex flex-col gap-1" action="{{ route('caso.parteContraria.update', $parteContrarium->id) }}">
                        @csrf
                        @method('PUT')
                          ...
                          <div class="w-full flex flex-col gap-1">
                            <div class="relative z-0 w-full mb-6 group">
                              <input type="text" 
                                ...
                                placeholder="" 
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                value="{{ $parteContrarium->telefono }}">
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                              <input type="text" 
                                ...
                                placeholder="" 
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                value="{{ $parteContrarium->direccion }}">
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                              <textarea class="resize-none block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" name="referencia" id="referencia" cols="30" rows="4" placeholder="">{{ $parteContrarium->referencia }}</textarea>
                        ...
                        <div class="sm:col-span-6 flex justify-center">
                          <button class="rounded-3xl overflow-hidden border font-bold border-blue-700 shadow-lg mb-4 py-2 px-9 bg-blue-700 text-white hover:bg-blue-800">Actualizar</button> 
                        </div>
                      </form>
                </div>
